      ...
      <div class="content-wrapper">
          ...
          <section class="content">
              ...
              <div class="box box-warning">
                  ...
                  <!-- form start -->
                  <form method="post" action="<?php echo site_url('absensi/procadd'); ?>" class="form-horizontal">
                      <div class="box-body">
                          <div class="form-group">
                              <label class="col-sm-2 control-label">ID Pertemuan</label>
                              <label class="col-sm-1 control-label">:</label>
                              <div class="col-sm-7">
                                  <input type="number" name="pertemuanid" class="form-control" required="required" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <label class="col-sm-1 control-label">:</label>
                              <div class="col-sm-7">
                                  <input type="number" name="registrasiid" class="form-control" required="required" />
                              </div>
                          </div>
                          <div style="clear: both;"></div>
                          <div class="form-group">
                              ...
                              <label class="col-sm-1 control-label">:</label>
                              <div class="col-sm-7">
                                  <input type="text" name="kdabsensi" class="form-control" required="required" />
                              </div>
                          </div>
                          <div style="clear: both;"></div>
