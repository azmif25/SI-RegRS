        ...
        <section class="content">
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
              ...
              <div style="clear: both;"></div>
              <div class="form-group">
                <label class="col-sm-2 control-label">No. Telepon Pasien</label>
                <label class="col-sm-1 control-label">:</label>
                <div class="col-sm-7">
                  <?php echo $telepon; ?>
                </div>
              ...
              <div style="clear: both;"></div>
              <?php if ($status == 'Tidak Layak') { ?>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Alasan Tidak Layak</label>
                  <label class="col-sm-1 control-label">:</label>
                  <div class="col-sm-7">
                    <?php echo $alasan_tolak; ?>
                  </div>
                </div>
                <div style="clear: both;"></div>
              <?php } ?> -->
