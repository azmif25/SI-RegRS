  ...
  <section class="content">
    ...
    <div class="box box-warning">
      ...
      <form method="post" enctype="multipart/form-data" action="<?php echo site_url('tujuan/procadd'); ?>" class="form-horizontal">
        <div class="box-body">
          <input type="hidden" class="form-control" name="nik" value="<?php echo $this->session->nik ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <div class="input-group">
                <!-- <input type="text" name="tgl_tujuan" class="form-control pull-right dttgl" value="<?php echo date("d-m-Y") + 1 ?>">
                <div class="input-group-addon bttgl">
                  <i class="fa fa-calendar"></i>
                </div>
              </div>/.input group -->
                <input type='text' name="tgl_tujuan" class="form-control" id="datepicker" value="<?php echo (new DateTime('tomorrow'))->format('d-m-Y'); ?>" />
