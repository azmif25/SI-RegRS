        ...
        <section class="content">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <p>
                <a href="<?php echo site_url('admin/addnew'); ?>" class="btn btn-success"><span class="fa fa-plus"></span> Tambah</a>
              </p>
                      ...
                      <td>
                        ...
                        <div class="input-group-btn">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="<?php echo site_url('admin/update/' . $r->id_admin . ''); ?>"><span class="fa fa-edit"></span> Ubah </a></li>
                            <li><a class="delbtn" href="javascript:;" onclick="<?php echo site_url('admin/delete/' . $r->id_admin . ''); ?>"><span class="fa fa-times"></span> Hapus</a></li>
                          </ul>
                        </div><!-- /btn-group -->
