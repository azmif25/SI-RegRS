      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box box-warning">
            ...
            <!-- form start -->
            <form method="post" action="<?php echo site_url('admin/procupd'); ?>" class="form-horizontal">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <label class="col-sm-1 control-label">:</label>
                  <div class="col-sm-7">
                    <input type="text" name="nama_admin" class="form-control" required="required" value="<?php echo $nama_admin; ?>" />
                  </div>
                </div>
                <div style="clear: both;"></div>
